<template>
  <div class="carrier-create">
    <el-page-header @back="goBack" title="返回承运商列表">
      <template #content>
        <span class="page-title">{{ isEdit ? '编辑承运商' : '新建承运商' }}</span>
      </template>
    </el-page-header>
...
import { createCarrier, updateCarrier, getCarrierDetail, type CreateCarrierParams } from '@/api/carrier'
...
const handleSubmit = async () => {
  ...
  try {
    if (isEdit.value) {
      await updateCarrier(Number(route.params.id), formData)
